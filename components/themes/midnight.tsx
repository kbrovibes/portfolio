...
const PROJECT_TONE: Record<string, { tile: string; iconBg: string; icon: string; tag: string; link: string }> = {
  ...
  sky:     { tile: "hover:border-sky-500/30 hover:bg-sky-500/[0.03]",         iconBg: "bg-sky-500/10",     icon: "text-sky-400",     tag: "bg-sky-500/10 text-sky-400/80 border-sky-500/15",         link: "hover:text-sky-400 hover:bg-sky-500/10" },
  pink:    { tile: "hover:border-pink-500/30 hover:bg-pink-500/[0.03]",       iconBg: "bg-pink-500/10",    icon: "text-pink-400",    tag: "bg-pink-500/10 text-pink-400/80 border-pink-500/15",       link: "hover:text-pink-400 hover:bg-pink-500/10" },
  teal:    { tile: "hover:border-teal-500/30 hover:bg-teal-500/[0.03]",       iconBg: "bg-teal-500/10",    icon: "text-teal-400",    tag: "bg-teal-500/10 text-teal-400/80 border-teal-500/15",       link: "hover:text-teal-400 hover:bg-teal-500/10" },
  indigo:  { tile: "hover:border-indigo-500/30 hover:bg-indigo-500/[0.03]",   iconBg: "bg-indigo-500/10",  icon: "text-indigo-400",  tag: "bg-indigo-500/10 text-indigo-400/80 border-indigo-500/15", link: "hover:text-indigo-400 hover:bg-indigo-500/10" },
...
function ProjectCard({ p }: { p: Project }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-white/40 leading-relaxed mb-3 flex-1">{p.description}</p>

      <div className="flex flex-wrap gap-1.5 mb-3">
        {p.tags.map((t) => (
          <span key={t} className={`px-2 py-0.5 rounded-md text-[10px] font-medium border ${tone.tag}`}>{t}</span>
        ))}
      </div>
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 pt-3 border-t border-white/[0.06] text-[11px] font-medium">
        ...
        <a href={p.page} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-white/45 transition-colors hover:text-white">
          <BookOpen size={11} /> Project page
        </a>
        <a href={p.repo} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-white/45 transition-colors hover:text-white">
    ...
    <section id="projects" className="py-10 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
          ...
          {/* All projects hub */}
          <motion.div variants={tileAnim} className="group relative flex flex-col justify-center rounded-2xl p-4 border overflow-hidden bg-gradient-to-br from-violet-500/[0.06] to-transparent border-violet-500/[0.14] hover:border-violet-500/30 transition-all duration-300">
            <div className="mb-3">
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] font-medium">
              <a href={HUB_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-violet-400 hover:text-violet-300 transition-colors">
                <ArrowUpRight size={11} /> All projects
              </a>
              <a href={PERSONAL.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-white/45 hover:text-white transition-colors">
